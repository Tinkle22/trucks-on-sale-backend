...
-- Alternative command if you need to add this table to an existing database
-- Make sure to run this in your MySQL/MariaDB database

-- Optional: Add some sample data for testing
-- INSERT INTO forms (name, email, phone, subject, message, dealership_id, dealership_name) 
-- VALUES 
-- ('John Doe', 'john@example.com', '+1234567890', 'Inquiry about trucks', 'I am interested in your truck inventory. Please contact me.', 1, 'ABC Motors'),
-- ('Jane Smith', 'jane@example.com', '+0987654321', 'Service inquiry', 'Do you provide maintenance services?', 2, 'XYZ Trucks');